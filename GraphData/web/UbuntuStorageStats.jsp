<%-- 
    Document   : UbuntuStorageStats
    Created on : May 2, 2014, 3:41:02 PM
    Author     : john
--%>
   ...
   <HEAD>
        ...
        <SCRIPT>
            ...
            function requestData() {
                $.ajax({
                    url: 'http://localhost:8084/GraphData/GetData?machine=<%=request.getParameter("machine")%>&resource=1&timestamp=0',
