<%-- 
    Document   : UbuntuCPUStats
    Created on : May 2, 2014, 3:36:39 PM
    Author     : john
--%>
     ...
     <HEAD>
        ...
        <SCRIPT>
            ...
            function requestData() {
                $.ajax({
                    url: 'http://localhost:8084/GraphData/GetData?machine=<%=request.getParameter("machine")%>&resource=3&timestamp=0',
