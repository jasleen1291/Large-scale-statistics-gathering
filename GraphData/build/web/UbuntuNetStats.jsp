<%-- 
    Document   : UbuntuNetStats
    Created on : May 2, 2014, 3:38:39 PM
    Author     : john
--%>
    ...
    <HEAD>
        ...
        <SCRIPT>
            ...
            function requestData() {
                $.ajax({
                    url: 'http://localhost:8084/GraphData/GetData?machine=<%=request.getParameter("machine")%>&resource=4&timestamp=0',
